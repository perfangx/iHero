...
//                               QuizOption(id: 14, optionId: "D", option: "Cortisol")]),
        ...
        QuizModel(quizTitle: "Abnormal Sugar Levels", quizLevelNum: 1, question: "Being physically active can’t lower the risk of developing diabetes and help you manage the disease if you already have it?",
                  answer: "B",
                  optionList: [QuizOption(id: 11, optionId: "A", option: "True"),
                               QuizOption(id: 12, optionId: "B", option: "False"),]),
        ...
        QuizModel(quizTitle: "Abnormal Sugar Levels", quizLevelNum: 1, question: "What is the first aid procedures for low blood sugar attack if the patient is unconscious ?",
                  ...
                  optionList: [QuizOption(id: 11, optionId: "A", option: "The patient is given half a cup of juice."),
                               ...
                               QuizOption(id: 14, optionId: "D", option: "All of the above")]),
        QuizModel(quizTitle: "Abnormal Sugar Levels", quizLevelNum: 1, question: "The first aid procedure for low blood sugar attack if the patient is conscious  The patient is injected with glucagon injection  If the injection is not available, the patient should be hospitalized as soon as possible?",
                  answer: "A",
                  optionList: [
        ...
        QuizModel(quizTitle: "CPR", quizLevelNum: 0, question: "How to use a head tilt method and chin lift",
                  ...
                  optionList: [QuizOption(id: 11, optionId: "A", option: "Place two under the patient chin and lift his head upwards"),
                               ...
                               QuizOption(id: 14, optionId: "D", option: "All the above")]),
        QuizModel(quizTitle: "CPR", quizLevelNum: 0, question: "Check the breathing , Hearing check by placing your ear close to the patient mouth and nose, these are the steps for ?",
                  answer: "B",
                  optionList: [
        ...
        QuizModel(quizTitle: "CPR", quizLevelNum: 0, question: "Perform artificial respiration by blowing into the patient's mouth twice slowly . Watch the height of the patient's chest  and wait for his chest to fall between the first and second puff ,when do you this operation ?",
                  ...
                  optionList: [QuizOption(id: 11, optionId: "A", option: "When the patient is breathing "),
                               ...
                               QuizOption(id: 14, optionId: "D", option: "None")]),
        QuizModel(quizTitle: "CPR", quizLevelNum: 0, question: "If there’s no signs that the Patient is still alive ?",
                  answer: "D",
                  optionList: [QuizOption(id: 11, optionId: "A", option: "Press the patient  chest to return his heart to work 15 times"),
                               ...
                               QuizOption(id: 14, optionId: "D", option: "All the above")]),
        QuizModel(quizTitle: "CPR", quizLevelNum: 0, question: "If there is no pulse, no need to  continue the rescue operation until the ambulance arrives ",
                  answer: "B",
                  optionList: [
                               QuizOption(id: 11, optionId: "A", option: "True"),
                               QuizOption(id: 12, optionId: "B", option: "False")]),
        ...
        QuizModel(quizTitle: "Burns", quizLevelNum: 0, question: "It is tissue damage caused by skin exposure to fire, prolonged exposure to sunlight or other radiation?",
                  answer: "A",
        ...
        QuizModel(quizTitle: "Burns", quizLevelNum: 0, question: "Burns is divided into 2 types ?",
                  ...
                  optionList: [
                               QuizOption(id: 11, optionId: "A", option: "True"),
                               QuizOption(id: 12, optionId: "B", option: "False")]),
        QuizModel(quizTitle: "Burns", quizLevelNum: 0, question: "It is important to know the most serious signs of skin burns  as moderate to severe burns can cause a number of serious complications and require urgent treatment?",
                  answer: "A",
                  optionList: [
                               QuizOption(id: 11, optionId: "A", option: "True"),
                               QuizOption(id: 12, optionId: "B", option: "False")]),
        ...
        QuizModel(quizTitle: "Burns", quizLevelNum: 0, question: " burns only include the top layer of skin,are painful, dry and turn white when pressed. Surface skin burns are in 3 to 6 days",
                  answer: "A",
        ...
        QuizModel(quizTitle: "Burns", quizLevelNum: 0, question: "Don’t touch the bubbles from burning , do not apply any ointments ,do not use ice directly on the burned area, these are the prudence for first degree burns?",
                  answer: "B",
                  optionList: [
                               QuizOption(id: 11, optionId: "A", option: "True"),
                               QuizOption(id: 12, optionId: "B", option: "False")]),
        ...
        QuizModel(quizTitle: "Burns", quizLevelNum: 0, question: "Third degree burn It is one of the most serious burns where all layers of the skin are included down to fat?",
                  answer: "A",
                  optionList: [
                               QuizOption(id: 11, optionId: "A", option: "True"),
                               QuizOption(id: 12, optionId: "B", option: "False")]),
