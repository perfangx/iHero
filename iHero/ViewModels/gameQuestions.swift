...
//                               QuizOption(id: 14, optionId: "D", option: "Cortisol")]),
        ...
        QuizModel(quizTitle: "Abnormal Sugar Levels", quizImage: "topic1Level1",quizLevelNum: 1, question: "Q: Diabetes divided into two types ?",
                  answer: "A",
                  optionList: [QuizOption(id: 11, optionId: "A", option: "True"),
                               QuizOption(id: 12, optionId: "B", option: "False"),
                               ]),
        QuizModel(quizTitle: "Abnormal Sugar Levels", quizImage: "topic1Level1",quizLevelNum: 1, question: "Q: What is type 1 diabetes ?",
                  answer: "C",
        ...
        QuizModel(quizTitle: "Abnormal Sugar Levels",quizImage: "topic1Level1", quizLevelNum: 1, question: "Q: What is the tips to control your blood sugar",
                  answer: "D",
        ...
        QuizModel(quizTitle: "Abnormal Sugar Levels",quizImage: "topic1Level1", quizLevelNum: 1, question: "Q: A low heart rate of less than 100 per minute , Feeling tired ,Unaware and thirst , is the symptoms for?",
                  answer: "B",
        ...
        QuizModel(quizTitle: "Abnormal Sugar Levels", quizImage: "topic1Level1",quizLevelNum: 1, question: "Q: What is the first aid procedures for high blood sugar attack",
                  answer: "D",
        ...
        QuizModel(quizTitle: "Abnormal Sugar Levels", quizImage: "topic1Level1",quizLevelNum: 1, question: "Q: Being physically active can’t lower the risk of developing diabetes and help you manage the disease if you already have it?",
                  answer: "B",
                  optionList: [QuizOption(id: 11, optionId: "A", option: "True"),
                               QuizOption(id: 12, optionId: "B", option: "False"),]),
        ...
        QuizModel(quizTitle: "Abnormal Sugar Levels",quizImage: "topic1Level1", quizLevelNum: 1, question: "Q: What is the Symptoms for low blood sugar attack ?",
                  answer: "D",
                  optionList: [QuizOption(id: 11, optionId: "A", option: "Feeling hungry"),
                               ...
                               QuizOption(id: 14, optionId: "D", option: "All of the above")]),
        QuizModel(quizTitle: "Abnormal Sugar Levels",quizImage: "topic1Level1", quizLevelNum: 1, question: "Q: What is the first aid procedures for low blood sugar attack if the patient is unconscious ?",
                  answer: "D",
                  optionList: [QuizOption(id: 11, optionId: "A", option: "The patient is given half a cup of juice."),
                               ...
                               QuizOption(id: 14, optionId: "D", option: "All of the above")]),
        QuizModel(quizTitle: "Abnormal Sugar Levels", quizImage: "topic1Level1",quizLevelNum: 1, question: "Q: The first aid procedure for low blood sugar attack if the patient is conscious  The patient is injected with glucagon injection  If the injection is not available, the patient should be hospitalized as soon as possible?",
                  answer: "A",
                  optionList: [
        ...
        QuizModel(quizTitle: "CPR", quizImage: "topic1Level1",quizLevelNum: 0, question: "Q: The human brain and heart cannot withstand the interruption of blood and oxygen for more than ….. minutes, as the cells of the brain and heart begin to die after the passage of these ….. minutes.",
                  answer: "A",
        ...
        QuizModel(quizTitle: "CPR", quizImage: "topic1Level1",quizLevelNum: 0, question: "Q: The importance of heart and lungs resuscitation is reflected in the fact that it provides the heart and brain with blood and oxygen to increase the chances of survival",
                  answer: "A",
                  optionList: [
                               QuizOption(id: 11, optionId: "A", option: "True"),
                               QuizOption(id: 12, optionId: "B", option: "False")]),
        QuizModel(quizTitle: "CPR",quizImage: "topic1Level1", quizLevelNum: 0, question: "Q: Every minute you pass the patient without ambulance reduces the chances of the patient surviving",
                  answer: "A",
                  optionList: [
                               QuizOption(id: 11, optionId: "A", option: "True"),
                               QuizOption(id: 12, optionId: "B", option: "False")]),
        ...
        QuizModel(quizTitle: "CPR", quizImage: "topic1Level1",quizLevelNum: 0, question: "Q: CPR is a ?",
                  answer: "D",
        ...
        QuizModel(quizTitle: "CPR", quizImage: "topic1Level1",quizLevelNum: 0, question: "Q: What causes CPR",
                  answer: "D",
        ...
        QuizModel(quizTitle: "CPR", quizImage: "topic1Level1",quizLevelNum: 0, question: "Q: It is the sudden cessation of the heart from beating so that the process of pumping blood to the lungs, brain and other organs stops?",
                  answer: "B",
        ...
        QuizModel(quizTitle: "CPR", quizImage: "topic1Level1",quizLevelNum: 0, question: "Q: The First step of the CPR is ?",
                  answer: "B",
        ...
        QuizModel(quizTitle: "CPR", quizImage: "topic1Level1",quizLevelNum: 0, question: "Q: How to use a head tilt method and chin lift",
                  answer: "D",
                  optionList: [QuizOption(id: 11, optionId: "A", option: "Place two under the patient chin and lift his head upwards"),
                               ...
                               QuizOption(id: 14, optionId: "D", option: "All the above")]),
        QuizModel(quizTitle: "CPR", quizImage: "topic1Level1",quizLevelNum: 0, question: "Q: Check the breathing , Hearing check by placing your ear close to the patient mouth and nose, these are the steps for ?",
                  answer: "B",
                  optionList: [
        ...
        QuizModel(quizTitle: "CPR", quizImage: "topic1Level1",quizLevelNum: 0, question: "Q: Perform artificial respiration by blowing into the patient's mouth twice slowly . Watch the height of the patient's chest  and wait for his chest to fall between the first and second puff ,when do you this operation ?",
                  answer: "C",
                  optionList: [QuizOption(id: 11, optionId: "A", option: "When the patient is breathing "),
                               ...
                               QuizOption(id: 14, optionId: "D", option: "None")]),
        QuizModel(quizTitle: "CPR", quizImage: "topic1Level1",quizLevelNum: 0, question: "Q: If there’s no signs that the Patient is still alive ?",
                  answer: "D",
                  optionList: [QuizOption(id: 11, optionId: "A", option: "Press the patient  chest to return his heart to work 15 times"),
                               ...
                               QuizOption(id: 14, optionId: "D", option: "All the above")]),
        QuizModel(quizTitle: "CPR", quizImage: "topic1Level1",quizLevelNum: 0, question: "Q: If there is no pulse, no need to  continue the rescue operation until the ambulance arrives ",
                  answer: "B",
                  optionList: [
                               QuizOption(id: 11, optionId: "A", option: "True"),
                               QuizOption(id: 12, optionId: "B", option: "False")]),
        ...
        QuizModel(quizTitle: "Burns", quizImage: "topic1Level1",quizLevelNum: 0, question: "Q: It is tissue damage caused by skin exposure to fire, prolonged exposure to sunlight or other radiation?",
                  answer: "A",
        ...
        QuizModel(quizTitle: "Burns", quizImage: "topic1Level1",quizLevelNum: 0, question: "Q: Burns is divided into 2 types ?",
                  answer: "B",
                  optionList: [
                               QuizOption(id: 11, optionId: "A", option: "True"),
                               QuizOption(id: 12, optionId: "B", option: "False")]),
        QuizModel(quizTitle: "Burns", quizImage: "topic1Level1",quizLevelNum: 0, question: "Q: It is important to know the most serious signs of skin burns  as moderate to severe burns can cause a number of serious complications and require urgent treatment?",
                  answer: "A",
                  optionList: [
                               QuizOption(id: 11, optionId: "A", option: "True"),
                               QuizOption(id: 12, optionId: "B", option: "False")]),
        ...
        QuizModel(quizTitle: "Burns", quizImage: "topic1Level1",quizLevelNum: 0, question: "Q: Burns only include the top layer of skin,are painful, dry and turn white when pressed. Surface skin burns are in 3 to 6 days",
                  answer: "A",
        ...
        QuizModel(quizTitle: "Burns", quizImage: "topic1Level1",quizLevelNum: 0, question: "Q: What is the first aid procedure for first degree burn ?",
                  answer: "D",
        ...
        QuizModel(quizTitle: "Burns", quizImage: "topic1Level1",quizLevelNum: 0, question: "Q: Don’t touch the bubbles from burning , do not apply any ointments ,do not use ice directly on the burned area, these are the prudence for first degree burns?",
                  answer: "B",
                  optionList: [
                               QuizOption(id: 11, optionId: "A", option: "True"),
                               QuizOption(id: 12, optionId: "B", option: "False")]),
        ...
        QuizModel(quizTitle: "Burns", quizImage: "topic1Level1",quizLevelNum: 0, question: "Q: Second burn degree is ?",
                  answer: "A",
        ...
        QuizModel(quizTitle: "Burns", quizImage: "topic1Level1",quizLevelNum: 0, question: "Q: What is the first aid procedure for second degree burn ?",
                  answer: "D",
        ...
        QuizModel(quizTitle: "Burns", quizImage: "topic1Level1",quizLevelNum: 0, question: "Q: What is the procedure for second degree burn",
                  answer: "D",
        ...
        QuizModel(quizTitle: "Burns", quizImage: "topic1Level1",quizLevelNum: 0, question: "Q: Third degree burn It is one of the most serious burns where all layers of the skin are included down to fat?",
                  answer: "A",
                  optionList: [
                               QuizOption(id: 11, optionId: "A", option: "True"),
                               QuizOption(id: 12, optionId: "B", option: "False")]),
        
        QuizModel(quizTitle: "Burns", quizImage: "topic1Level1",quizLevelNum: 0, question: "Q: What is the first aid procedure for third degree burn?",
                  answer: "D",
        ...
        QuizModel(quizTitle: "Burns", quizImage: "topic1Level1",quizLevelNum: 0, question: "Q: What is the wrong procedures to do with third degree burns?",
                  answer: "D",
